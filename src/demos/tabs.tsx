      ...
      <div className="min-h-screen bg-background">
        <header className="border-b bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-card/50">
          <div className="container mx-auto px-4 py-6">
            <h1 className="text-2xl font-bold text-foreground">Tabs Demo</h1>
            <p className="text-sm text-muted-foreground">Timeline, Calendar, and Summary tabs.</p>
          </div>
        </header>
              ...
              <div className="rounded-lg border bg-card/50 p-6">
                ...
                {filteredEntries.length === 0 ? (
                  ...
                  <div className="space-y-0">
                    {filteredEntries.map((entry: TimelineEntryData) => (
...
createRoot(document.getElementById("root")!).render(<TabsDemo />);
